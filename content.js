...
(function () {
  ...
  const QUIZZES = {
    ...
    "漢検/10級/dai1kai": [
      { q:"「一年生（いちねんせい）」の「一」の 読み方は？",
        a:["いち","に","さん","し"], c:0,
        hint:"かずを かぞえる とき、いちばん さいしょに 言う かず。",
        speech_text:"いちねんせいの いちの よみかたは？",
        job_title:"「一」バッチリ！",
      ...
      { q:"「花火（はなび）」の「花」の 読み方は？",
        a:["はな","くさ","き","は"], c:0,
        hint:"チューリップや ひまわりの ことを かん字で 書くと？",
        job_title:"「花」バッチリ！",
        job_desc:"「花」は「はな」と 読むよ。「花火」は「花」のように 空に ひらく 火、という 意味だよ。" },

      { q:"「火（か）よう日」の「火」の 読み方は？",
        a:["か","すい","もく","きん"], c:0,
      ...
      { q:"「おと」を あらわす かん字は どれ？",
        ...
        job_title:"「音」を 見つけた！",
        job_desc:"「おと」を あらわす かん字は「音」。「音楽（おんがく）」の「音」でもあるね。" },

      { q:"「王（おう）」は 何画（なんかく）で 書く かん字？",
        a:["4画","3画","5画","6画"], c:0,
        hint:"よこ・よこ・たて・よこ。ゆっくり かぞえてみよう。",
        job_title:"画数（かくすう）マスター！",
        job_desc:"「王」は 4画。かん字を 書く ときの 線の 数を「画数」と いうよ。書き順（かきじゅん）も いっしょに おぼえよう。" },

      { q:"「貝（かい）」は 何画で 書く かん字？",
        a:["7画","5画","9画","6画"], c:0,
        hint:"上の「目」みたいな 形が ６画、下に 2画 たすよ。",
        job_title:"画数（かくすう）マスター！",
        job_desc:"「貝」は 7画。海に いる、あの「かい」だね。「貝」が つく かん字（う海・かい）は たくさん あるよ。" },

      { q:"【問題の ねらいを 見ぬこう】",
        scenario:[
          { name:"ニコ", icon:"🦄", msg:"漢検の もんだいで『つぎの かん字の 読みがなを 書きましょう』って よく 出るよ。<br>これは <b>なにが できると OK</b>かな？" }
        ],
        a:["かん字を 見て、正しい 読み方が わかるか","絵が じょうずに かけるか","走るのが はやいか","歌が じょうずか"], c:0,
        hint:"『読みがなを 書く』が ポイントだね。",
        speech_text:"この もんだいの ねらいは？",
        job_title:"🎯 ねらいを 見ぬいた！",
        job_desc:"ねらいは『かん字を 見て、正しい 読み方が わかるか』。漢検では、読み・書き・画数の 3つを まんべんなく 聞かれるよ。" },
