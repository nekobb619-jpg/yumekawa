...
(function () {
  ...
  const QUIZZES = {
    ...
    "算数/グラフ/oresen01": [
      ...
      { q:"折れ線グラフで、数量が ふえたり へったり する 様子のことを ひらがな4文字で「〇〇〇〇」というよ。書こう。",
    ...
    "理科/雨水/amamizu01": [
      ...
      { q:"水が 水蒸気になって 空気中に のぼっていく ことを ひらがな4文字で「〇〇〇〇」というよ。書こう。",
        type:"text_input", correct_answers:["じょうはつ","蒸発"],
        hint:"『じょ◯はつ』。水たまりが かわく 原因だよ。",
    ...
    "社会/水道/josuijo01": [
      ...
      { q:"川の水を 消毒して 安全な 水にする 施設を ひらがな5文字で「〇〇〇〇〇」というよ。書こう。",
        type:"text_input", correct_answers:["じょうすいじょう","浄水場"],
        hint:"『じょ◯すいじょう』。きれいな 水をつくるよ。",
