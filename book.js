...
(function () {
  ...
  const STORIES = [
    ...
    {
      id: "book21",
      title: "わけると 生まれかわる ごみ",
      icon: "🗑️",
      body: "そうまさんは お母さんと、ペットボトルを あらって、キャップと 本体を 分けて すてていました。「どうして、こんなに めんどうな 分け方を するの？」と 聞くと、お母さんが 教えてくれました。「正しく 分けると、ペットボトルは また 新しい せいひんに 生まれかわれるんだよ。でも ちがう ごみが まざっていると、リサイクルできなく なっちゃうんだ」\n\n次の日、そうまさんは 学校で リサイクル工場の 見学に 行き、細かく くだかれた プラスチックが、糸や 新しい 服の 材料に なる ようすを 見て、びっくりしました。「ぼくが 分けた ごみが、こんな ものに なるんだ！」と、そうまさんは ごみの 分け方を もっと ていねいに するように なりました。",
      quiz: [
        { q: "正しく ごみを 分けると、どんな よいことが ありますか？",
          a: ["ごみが 新しい せいひんに 生まれかわれる", "ごみが すぐに 消えて なくなる", "ごみばこが 大きくなる", "お金が もらえる"], c: 0,
          hint: "お母さんの セリフを 読みかえそう。" }
      ]
    },
    {
      id: "book22",
      title: "がい数で かぞえた おまつり",
      icon: "🏮",
      body: "夏まつりで、ゆうなさんは 屋台に ならんだ 人の 数を 数えようとしましたが、多すぎて 数えきれません。「そういう ときはね、がい数を 使うと いいんだよ」と お父さんが 教えてくれました。「10人ずつ かたまりに して、だいたい 何こ あるか 見るんだ」\n\nゆうなさんが 10人の かたまりを 目で 数えると、「6つ くらい あるから、だいたい 60人だね！」と こたえられました。あとで 係の 人に 聞くと、じっさいの 人数は 58人。「ぴったり じゃなくても、だいたいの 数が わかれば べんりなんだね」と、ゆうなさんは がい数の 便利さに 気づきました。",
      quiz: [
        { q: "がい数を 使うと、どんな ときに べんりですか？",
          a: ["正確な 数を 数えきれない とき、だいたいの 数を つかめる", "1つも 数えなくて いいので 楽", "計算が まったく いらなくなる", "答えが いつも 0に なる"], c: 0,
          hint: "お父さんの セリフを 読みかえそう。" }
      ]
    },
    {
      id: "book23",
      title: "冬の 空の 三角形",
      icon: "⭐",
      body: "冬の 夜、りょうさんは お父さんと 庭に 出て、星を 見あげました。「あの 赤い 星が オリオン座の ベテルギウス、あっちの 白い 星が おおいぬ座の シリウス、そして あそこの 少し くらい 星が こいぬ座の プロキオンだよ」\n\nお父さんは 3つの 明るい 星を つないで、「見て、大きな 三角形が できるでしょう？ これを 冬の大三角と 呼ぶんだ」\n\nりょうさんは 空を 見あげて、ほんとうに 大きな 三角形が うかんでいるのを 見つけました。「星と 星を つなぐと、いろんな 形が 見えてくるんだね」と、りょうさんは 星空が もっと 好きに なりました。",
      quiz: [
        { q: "りょうさんが 見つけた、3つの 明るい 星を つないで できる 形は 何ですか？",
          a: ["三角形（冬の大三角）", "四角形", "丸い 形", "星の 形"], c: 0,
          hint: "お父さんの セリフ「大きな 三角形が…」を 読もう。" }
      ]
    },
    {
      id: "book24",
      title: "石の上にも 三年",
      icon: "🪨",
      body: "水泳が 苦手な あかりさんは、何度 れんしゅうしても うまく 泳げず、やめたく なっていました。おばあちゃんに そのことを 話すと、「『石の上にも 三年』って ことわざを 知ってる？」と 聞かれました。「つめたい 石の上でも、三年も すわりつづければ あたたかく なる、つまり がまんして つづければ、いつか うまく いくよ、という 意味なんだよ」\n\nあかりさんは その言葉を 思い出しながら、毎週 プールに 通いつづけました。3か月後、あかりさんは とうとう 25メートルを 泳ぎきることが できました。「ほんとうに、つづけて よかった」と、あかりさんは にっこり しました。",
      quiz: [
        { q: "「石の上にも 三年」は、どんな 意味の ことわざですか？",
          a: ["がまんして つづければ、いつか うまく いく", "石は あたたかい", "三年 たつと 石に なる", "水泳が 一番 大事"], c: 0,
          hint: "おばあちゃんの セリフを 読みかえそう。" }
      ]
    },
    {
      id: "book25",
      title: "はがきで とどいた 北海道",
      icon: "📮",
      body: "なぎささんは 学校の 交流会で、北海道に すむ 同じ 学年の 子と 文通することに なりました。とどいた はがきには、「こっちは もう 雪が つもってるよ！ ラベンダー畑や、おいしい とうもろこしが 有名なんだ」と 書いてありました。\n\nなぎささんは 地図帳で 北海道の 場所を さがし、「日本で いちばん 北に あって、いちばん 面積が 広い 都道府県なんだ！」と 発見しました。返事の はがきに、自分の 住む 町の じまんを 書いて 送ると、しばらくして「今度、遊びに 行きたいな」という 返事が とどきました。",
      quiz: [
        { q: "北海道について、なぎささんが 地図帳で 発見した ことは 何ですか？",
          a: ["日本で いちばん 面積が 広い 都道府県", "日本で いちばん 面積が せまい 都道府県", "都道府県の 数が いちばん 多い", "海に 面していない 県"], c: 0,
          hint: "なぎささんの セリフ「日本で いちばん…」を 読もう。" }
      ]
    },
    {
      id: "book26",
      title: "はじめましての ドキドキ",
      icon: "🎒",
      body: "4月、ゆうとさんの クラスに、転校生（てんこうせい）の みなとさんが やってきました。みなとさんは 緊張（きんちょう）した 顔で、だれとも 話さず、休み時間も 1人で いました。\n\nゆうとさんは 声を かけようか まよいましたが、思いきって「休み時間、いっしょに おにごっこ しない？」と 話しかけました。みなとさんは 少し おどろいた 顔を したあと、「うん！」と、うれしそうに うなずきました。\n\n1週間後には、みなとさんは クラスの みんなと すっかり なかよくなり、「あのとき 声を かけて くれて、ありがとう」と ゆうとさんに 言いました。",
      quiz: [
        { q: "ゆうとさんは、転校生の みなとさんに 何を しましたか？",
          a: ["いっしょに 遊ぼうと 声を かけた", "見て 見ぬふりを した", "いじわるを した", "先生に 言いつけた"], c: 0,
          hint: "ゆうとさんの セリフを 読みかえそう。" }
      ]
    },
    {
      id: "book27",
      title: "がまんの さきに あった プレゼント",
      icon: "🐷",
      body: "まほさんは 毎月の おこづかいを もらうたびに、大すきな お菓子を すぐに 買っていました。でも ある日、お店で すてきな 絵本セットを 見つけ、「これ、ほしいな」と 思いました。ねだんを 見ると、おこづかい 3か月分。\n\nお母さんと 相談して、まほさんは 貯金箱を 用意し、毎月 半分だけ 貯めることに しました。お菓子を がまんする日も ありましたが、3か月後、貯金箱には ちょうど 絵本セットが 買える 金がくが たまっていました。「自分で 貯めた お金で 買うのって、こんなに うれしいんだね」と、まほさんは 大切そうに 絵本を だきしめました。",
      quiz: [
        { q: "まほさんは、絵本セットを 買うために 何を しましたか？",
          a: ["おこづかいを 毎月 少しずつ 貯金した", "お母さんに すぐ 買ってもらった", "お菓子を たくさん 買った", "絵本を あきらめた"], c: 0,
          hint: "「貯金箱を 用意し…」の あとを 読もう。" }
      ]
    },
    {
      id: "book28",
      title: "見えない チカラ、じしゃく",
      icon: "🧲",
      body: "りくさんは、じしゃくで 遊んでいて、ふしぎな ことに 気づきました。クリップは くっつくのに、消しゴムや 1円玉は くっつきません。「なんでだろう？」と 先生に 聞くと、「じしゃくは、鉄で できた ものだけを 引きつける チカラを 持っているんだよ。クリップは 鉄だけど、1円玉は アルミニウムという べつの 金ぞくで できているから、くっつかないんだ」と 教えてくれました。\n\nりくさんは 家に 帰って、いろいろな ものを じしゃくに 近づけて 調べ、鉄の くぎや スプーンは くっつくのに、木や プラスチックの ものは くっつかないことを たしかめました。",
      quiz: [
        { q: "じしゃくに くっつくのは、どんな もので できた ものですか？",
          a: ["鉄で できた もの", "木で できた もの", "アルミニウムで できた もの", "紙で できた もの"], c: 0,
          hint: "先生の セリフ「鉄で できた ものだけを…」を 読もう。" }
      ]
    },
    {
      id: "book29",
      title: "すすんで やる おてつだい",
      icon: "🧹",
      body: "そらさんの 家では、週ごとに お手伝い当番を 決めていましたが、そらさんは いつも「今日は めんどうだな」と 思いながら やっていました。ある日、当番でもないのに、お母さんが 荷物で 両手が ふさがっているのを 見て、そらさんは とっさに ドアを 開けて あげました。\n\nお母さんは「ありがとう、助かったよ」と、にっこり わらいました。その日から、そらさんは 当番の日じゃなくても、こまっている 人を 見つけたら、すすんで 手伝うように なりました。「頼まれる 前に 気づいて 動くのって、いい 気分だな」と そらさんは 思いました。",
      quiz: [
        { q: "そらさんは、当番でない日でも どうするように なりましたか？",
          a: ["こまっている 人を すすんで 手伝うように なった", "お手伝いを 一切 やめた", "当番の日だけ 手伝った", "お母さんに おこられた"], c: 0,
          hint: "さいごの 2文を 読みかえそう。" }
      ]
    },
    {
      id: "book30",
      title: "みんなで つくる げき",
      icon: "🎭",
      body: "学芸会（がくげいかい）の げきの 練習で、せりふを 覚えるのが 苦手な めいさんは、自信を なくしていました。リーダーの こうきさんは、それに 気づいて「せりふカードを いっしょに 作ろうよ。ぼくも 苦手な ところ あるし」と 声を かけました。\n\nクラスの みんなで、大きな 絵入りの せりふカードを 作って、休み時間に 練習しあいました。学芸会 当日、めいさんは カードを 思い出しながら、大きな 声で せりふを 言うことが できました。げきが 終わったあと、クラスの みんなで「がんばったね！」と、たがいに たたえあいました。",
      quiz: [
        { q: "こうきさんは、せりふが 苦手な めいさんの ために 何を しましたか？",
          a: ["いっしょに せりふカードを 作ろうと さそった", "めいさんの 役を とりあげた", "見て 見ぬふりを した", "1人で れんしゅうさせた"], c: 0,
          hint: "こうきさんの セリフを 読みかえそう。" }
      ]
    }
  ];
  ...
  window.renderBookQuestion = function () {
    ...
    // ★2026-08-08修正：それまでq.aの並び順をそのまま描画しており、全話・全問で正解(c)が
    //   常にインデックス0＝一番上のボタンになっていた（読まずに一番上を押せば満点が取れてしまう不具合）。
    //   表示のたびにシャッフルし、st.currentOrder（表示位置→元のインデックス）で対応づける。
    const order = q.a.map(function (_, i) { return i; });
    for (let i = order.length - 1; i > 0; i--) {
      const j = Math.floor(Math.random() * (i + 1));
      const tmp = order[i]; order[i] = order[j]; order[j] = tmp;
    }
    st.currentOrder = order;
    const btnsHtml = order.map(function (origIdx, pos) {
      return '<button class="choice-btn" onclick="window.answerBookQuestion(' + pos + ')">' + q.a[origIdx] + "</button>";
    }).join("");
    body.innerHTML =
  ...
  window.answerBookQuestion = function (choicePos) {
    const st = window.bookState;
    if (!st) return;
    const q = st.story.quiz[st.qIndex];
    const order = st.currentOrder || q.a.map(function (_, i) { return i; });
    const correctPos = order.indexOf(q.c);
    const buttons = document.querySelectorAll("#book-quiz-choices .choice-btn");
    buttons.forEach(function (b, pos) {
      b.onclick = null;
      if (pos === correctPos) b.classList.add("correct");
      else if (pos === choicePos) b.classList.add("wrong");
    });
    const correct = (choicePos === correctPos);
