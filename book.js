...
(function () {
  ...
  const STORIES = [
    ...
    {
      id: "book16",
      title: "折れ線グラフと ニコの 発見",
      icon: "📈",
      body: "夏休み、あおいさんと ニコは、1時間ごとに 気温を 測って 折れ線グラフを 作ってみました。\n\n「朝の 9時は 20度だったのに、昼の 2時には 30度まで 上がったよ！」と あおいさんが 叫びました。\n\nニコは グラフの 線を 指さして「線が 上に 急に かたむいている ときは、気温が 急激に ふえた 証拠（しょうこ）だね！ 変化の 様子が ひと目で 分かって すごいね」と 感動しました。\n\nふたりは、グラフの おかげで 気温の 変化が よく 分かり、大満足でした。"
      ,
      quiz: [
        { q: "折れ線グラフを つくると、どんな ことが ひと目で 分かりますか？",
          a: ["時間の経過による 数量の変化", "文字の きれいさ", "お金の 合計", "人の 人数"], c: 0,
          hint: "ニコの セリフ「変化の 様子が ひと目で…」に ちゅうもく。" },
        { q: "グラフの 線が 上に 急に かたむいている とき、数量は どうなっていますか？",
          a: ["急激に 増えている", "へっている", "全く 変わっていない", "ゼロになった"], c: 0,
          hint: "「気温が 急激に…」の 部分を 読みかえそう。" }
      ]
    },
    {
      id: "book17",
      title: "雨水の ゆくえと 水たまり",
      icon: "💧",
      body: "雨あがりの 校庭で、けんたさんは 大きな 水たまりを 見つけました。\n\n「次の 日には、この 水たまりは どこへ 行っちゃうのかな？」と けんたさんが 不思議そうに 言うと、ニコが 教えてくれました。\n\n「水には 2つの ゆくえが あるんだよ！ 一つは 土の すきまを通って 地中に しみこむルート。もう一つは 太陽の 熱で 水蒸気（すいちょうき）になって 空へ 蒸発する ルートだよ」\n\n次の日、水たまりが 消えた 校庭を 見て、けんたさんは「空と 地面に おひっこししたんだね」と にっこり 笑いました。"
      ,
      quiz: [
        { q: "地面に たまった 雨水には、どんな 2つの ゆくえが ありますか？",
          a: ["土の中に しみこむ・空気中に 蒸発する", "魔法で 消える・石に 変わる", "宇宙へ いく・そのまま 残る", "地下深くに 固まる"], c: 0,
          hint: "ニコの セリフ「一つは 土の… もう一つは…」を 読もう。" }
      ]
    },
    {
      id: "book18",
      title: "じゃぐちの むこうの 浄水場",
      icon: "🚰",
      body: "暑い日、公園で たっぷり 遊んだ ゆいさんは、じゃぐちを ひねって 冷たい 水を 飲みました。\n\n「どうして 日本の 水道水は、そのまま 安心して 飲めるのかな？」と ゆいさんが つぶやくと、ニコが 話しかけました。\n\n「それはね、浄水場（じょうすいじょう）で 働いている 人たちが、24時間体制で 川の 水の ゴミを のぞき、薬で 消毒して 安全を たしかめているからだよ！ 世界でも そのまま 飲める 国は 10〜15か国くらいしか ないんだよ」\n\nゆいさんは「すごいんだね！ 水を 大切に 使うね」と 感謝しました。"
      ,
      quiz: [
        { q: "私たちが 安心して 飲める 水は、どこで きれいに 消毒されていますか？",
          a: ["浄水場（じょうすいじょう）", "消防署", "ごみ処理場", "公園の 屋根"], c: 0,
          hint: "「浄水場で 働いている 人たちが…」の 部分を 読もう。" }
      ]
    },
    {
      id: "book19",
      title: "漢字の 音と 訓の ひみつ",
      icon: "📖",
      body: "漢字の 宿題を していた りくさんは、首を ひねっていました。「『山（やま）』と『山脈（サンミャク）』、どうして 読み方が ２つも あるんだろう？」\n\nニコが にっこり 笑って 教えてくれました。「『やま』は 日本で もともと 使われていた 訓読み（くんよみ）で、1文字で 意味が わかるよ。『サン』は 昔の 中国から 伝わった 音読み（おんよみ）で、他の 漢字と くみあわせて 熟語で 使うんだよ」\n\nりくさんは「なるほど！ １文字で 意味が わかるのが 訓読みなんだね」と、漢字の ひみつを 発見して うれしくなりました。"
      ,
      quiz: [
        { q: "「山（やま）」のように、その 漢字 1文字だけで 意味が わかる 読み方を 何という？",
          a: ["訓読み（くんよみ）", "音読み（おんよみ）", "英語読み", "中国読み"], c: 0,
          hint: "ニコの セリフ「1文字で 意味が わかるよ」の 前を 見よう。" }
      ]
    },
    {
      id: "book20",
      title: "友達（ともだち）に おしえる 魔法",
      icon: "🦄",
      body: "わり算の 筆算が 少し 苦手だった はるきさんは、ノートを 前に こまっていました。\n\n相棒の ニコが「はるきさん！ ぼくに 解き方を セリフで 教えてみて！」と 言いました。\n\nはるきさんは「まず 商を たてて、かけ算して、ひき算して、つぎの 数字を おろすんだよ」と ニコに 一生懸命 説明しました。すると 不思議なことに、自分の あたまの 中も すっきり 整理されました。\n\n「人に 教えると、自分の 理解も ふかまるんだね！」と はるきさんは 笑顔になりました。"
      ,
      quiz: [
        { q: "はるきさんは、ニコに 解き方を 説明したあと どうなりましたか？",
          a: ["自分の あたまの 中も 整理されて 笑顔になった", "もっと 分からなくなった", "勉強を やめてしまった", "何も かわらなかった"], c: 0,
          hint: "「自分の あたまの 中も…」の あとを 読みかえそう。" }
      ]
    }
  ];
