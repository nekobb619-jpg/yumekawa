  ...
  const QUIZZES = {
    "理科/電気/denki01": [
      ...
      { q:"豆電球3こを つないだ かいろで、\nじょうけん：1この 豆電球が きれても、のこりの 2こは 光り続けてほしい。\n\nこの じょうけんに あう つなぎ方は どれでしょう？",
        a:["へいれつつなぎ","直列つなぎ","どちらでもよい","つなぎ方に関係ない"], c:0,
    ...
    "理科/星/hoshi01": [
      ...
      { q:"満月は「太陽ー地球ー月」が 一直線に 並んだときに 見えます。ある日の 夕方、太陽が 西に しずむのと 同時に、東の空に 満月が のぼるのが 見えました。この 観察は、満月の しくみと 合っているでしょうか？",
        a:["合っている（地球をはさんで太陽と月が反対側にあるから）","合っていない（方角が逆だから）","合っていない（同時にのぼるはずがないから）","わからない"], c:0,
    ...
    "理科/季節と生き物/kisetsu01": [
      ...
      { q:"モンシロチョウは「さなぎ」、カマキリは「たまご」、テントウムシは「成虫」と、冬のこし方が それぞれ ちがいます。もし 冬に「木の枝に ぶら下がっている 虫」を 見つけたら、その虫は どの仲間だと 考えられるでしょう？",
        a:["チョウの仲間（さなぎのすがた）","カマキリの仲間","テントウムシの仲間","ツバメの仲間"], c:0,
    ...
    "理科/空気と水/kuki_mizu01": [
      ...
      { q:"空気でっぽうは、玉と玉の間の空気を「大きく・強く」押し縮めるほど、勢いよく玉が飛び出すのでした。では、押し縮める空気の量を「多く」した場合と「少しだけ」にした場合で、飛び出す勢いに ちがいは あるでしょうか？",
        a:["多く縮めたほうが 勢いが 強くなる","少ないほうが 勢いが 強くなる","どちらも 同じ 勢い","飛び出さなくなる"], c:0,
    ...
    "理科/あたたまり方/atatamari01": [
      ...
      { q:"金属は「熱した場所から順々に熱が伝わる」、水は「温まった部分そのものが移動して全体があたたまる（対流）」のでした。この2つの あたたまり方に 共通する 点は どれでしょう？",
        a:["どちらも、あたたかい場所から遠くへ、だんだん広がっていく","どちらもまったく同じ動き方をする","どちらもあたたまらない","金属だけがあたたまる"], c:0,
    ...
    "理科/雨水/amamizu01": [
      ...
      { q:"粒が大きいジャリのほうが水がしみこみやすい、そして日なたのほうが水たまりが早く蒸発するのでした。では、『日なたにある、ジャリを多くしいた地面』と『日かげにある、土だけの地面』では、雨のあと水たまりが早く消えるのは どちらでしょう？",
        a:["日なたのジャリを多くしいた地面","日かげの土だけの地面","どちらも同じ速さ","消えない"], c:0,
    ...
    "理科/磁石/jishaku301": [
      ...
      { q:"棒磁石Aと 棒磁石Bが あります。AのN極と BのS極を 近づけると 引き合いました。では、AのN極と BのN極を 近づけると どうなるでしょう？",
        a:["しりぞけあう（同じ極どうしだから）","引き合う","何も起きない","磁石がこわれる"], c:0,
    ...
    "理科/体/karada01": [
      ...
      { q:"腕を曲げるときは「内側の筋肉が縮み、外側の筋肉が伸びる」のでした。では、腕をまっすぐ伸ばすときは、内側と外側、どちらの筋肉が縮むでしょう？",
        a:["外側の筋肉","内側の筋肉","両方とも縮む","どちらも縮まない"], c:0,
