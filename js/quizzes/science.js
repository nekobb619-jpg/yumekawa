...
(function () {
  ...
  "理科/電気/denki01": [
    ...
    {
      "q": "直列（ちょくれつ）つなぎの 回路で、2つの 電球のうち 1つを はずすと、もう1つの 電球は どうなる？",
      "a": [
        "消える（電流の通り道が 切れるから）",
        "2倍 あかるくなる",
        "変わらず ついている",
      ...
      "c": 0,
      "hint": "直列つなぎは、1本の一本道！1箇所でも切れると電気は流れないよ。",
      "thinking": true,
      "speech_text": "1つはずすと どうなる？",
      "job_title": "【回路のトラブルシューター】",
      "job_desc": "直列つなぎは一本道だから、途中で1つでも切れると回路全体に電流が流れなくなるんだね！"
    }
  ],
  "理科/星/hoshi01": [
    {
  ...
  // ★2026-09-12追加：4年生2学期「すがたを変える水」（水の三態変化）。AGENTS.md 3.5適用ずみ。
  "理科/水のすがた/sugata01": [
    {
      "q": "水を 熱し続けると、100℃くらいで さかんに あわを出して わきたつ。この ようすを 何という？",
      "a": ["沸騰（ふっとう）", "蒸発（じょうはつ）", "融解（ゆうかい）", "結露（けつろ）"],
      "c": 0,
      "hint": "やかんのお湯が グツグツ する 時の 現象だよ。",
      "job_title": "沸騰（ふっとう）はっけん！",
      "job_desc": "水は 100℃くらいで さかんに あわを 出して わきたつよ。これを「沸騰」というよ。"
    },
    {
      "q": "水が 沸騰している とき、さかんに 出ている あわの 正体は 何？",
      "a": ["水が 気体に なった 水蒸気（すいじょうき）", "空気そのもの", "二酸化炭素", "水素ガス"],
      "c": 0,
      "hint": "水が すがたを 変えて 気体に なった ものだよ。",
      "job_title": "水蒸気（すいじょうき）はっけん！",
      "job_desc": "沸騰した ときに 出る あわの 正体は、水が 気体に 変わった「水蒸気」だよ。水蒸気そのものは 目には 見えないよ。"
    },
    {
      "q": "やかんの 口から 出ている 白い ゆげ（湯気）の 正体は？",
      "a": ["水蒸気が 空気で 冷やされて できた 小さな 水のつぶ", "水蒸気そのもの（気体）", "煙（けむり）", "二酸化炭素"],
      "c": 0,
      "hint": "湯気は 気体ではなく、冷えて できた 小さな 水のつぶだよ。",
      "job_title": "湯気（ゆげ）の正体、発見！",
      "job_desc": "湯気は、目に見えない 水蒸気が 空気に 冷やされて、目に見える 小さな 水のつぶ（液体）に もどった ものだよ。"
    },
    {
      "q": "洗濯物が 太陽の光や 風で 乾いて いくのは、水が 何に 変わって 空気中に 出ていくから？",
      "a": ["水蒸気", "氷", "湯気", "水滴"],
      "c": 0,
      "hint": "沸騰しなくても、水は ゆっくり 気体に 変わることが あるよ。",
      "job_title": "蒸発（じょうはつ）はっけん！",
      "job_desc": "100℃に ならなくても、水は 少しずつ 水蒸気に なって 空気中に 出ていくよ。これを「蒸発」というよ。"
    },
    {
      "q": "水を どんどん 冷やして いくと、0℃くらいで 何に 変わる？",
      "a": ["氷（こおり）", "湯気", "水蒸気", "炭酸"],
      "c": 0,
      "hint": "冷凍庫に 入れた 水が どうなるか 思い出そう。",
      "job_title": "こおる温度、発見！",
      "job_desc": "水は 0℃くらいで こおって「氷」に なるよ。この 変化を「凝固（ぎょうこ）」というよ。"
    },
    {
      "q": "氷を あたためて いくと、何℃くらいで とけて 水に もどる？",
      "a": ["0℃くらい", "100℃くらい", "-10℃くらい", "50℃くらい"],
      "c": 0,
      "hint": "氷が とけ始める 温度は 決まっているよ。",
      "job_title": "とける温度、発見！",
      "job_desc": "氷は 0℃くらいで とけて 水に もどるよ。この 変化を「融解（ゆうかい）」というよ。"
    },
    {
      "q": "水（えき体）・氷（こ体）・水蒸気（気体）のように、温度によって すがたが 変わる ことを 何という？",
      "a": ["状態変化（じょうたいへんか）", "化学変化", "対流", "反射"],
      "c": 0,
      "hint": "「状態」が「変化」する、そのままの 言葉だよ。",
      "job_title": "状態変化（じょうたいへんか）マスター！",
      "job_desc": "温度によって 固体・液体・気体と すがたが 変わることを「状態変化」というよ。"
    },
    {
      "q": "水が こおって 氷に なると、体積（かさ）は どうなる？",
      "a": ["少し 大きくなる", "少し 小さくなる", "まったく 変わらない", "半分に なる"],
      "c": 0,
      "hint": "冷凍庫で こおった ペットボトルが ふくらんで いたことは ないかな？",
      "rescue_hint": "「大きくなる」だよ。だから 凍った 水筒は パンパンに ふくらむんだ。",
      "job_title": "こおると大きくなる！？",
      "job_desc": "水は こおると 体積が 少し 大きくなるよ。だから 冬に 水道管が こおって 破れつする ことも あるんだ。"
    },
    {
      "q": "冷たい ジュースの入った コップの 外側に、水てきが つくのは なぜ？",
      "a": ["空気中の 水蒸気が 冷やされて 水に もどったから", "コップの中の ジュースが しみ出したから", "空気中の 酸素が 変化したから", "コップが とけたから"],
      "c": 0,
      "hint": "コップの中身が もれて いるわけでは ないよ、まわりの 空気に 注目。",
      "job_title": "結露（けつろ）はっけん！",
      "job_desc": "空気中の 目に見えない 水蒸気が、冷たい コップに ふれて 冷やされ、水てきに もどることを「結露」というよ。"
    },
    {
      "q": "冬の 朝、窓ガラスや 地面に つく 白い こなの ような ものを 何という？",
      "a": ["霜（しも）", "雪（ゆき）", "雲（くも）", "露（つゆ）"],
      "c": 0,
      "hint": "空気中の 水蒸気が、冷たい ものに ふれて 直接 こおった ものだよ。",
      "thinking": true,
      "job_title": "霜（しも）はっけん！",
      "job_desc": "空気中の 水蒸気が 冷たい ものに ふれて 直接 こおると「霜（しも）」に なるよ。"
    }
  ]
};
})();
