  ...
  const QUIZZES = {
    "社会/地図/nairiku01": [
      ...
      { q:"日本でいちばん 大きい湖（琵琶湖）が ある 内陸県は どこ？ ひらがなで 書こう。",
        type:"text_input", correct_answers:["しがけん","しが"],
        hint:"近畿地方に ある 内陸県だよ。",
    ...
    "社会/水道/josuijo01": [
      ...
      { q:"水は「川・ダム→浄水場→家（使う）→下水処理場→川・海」の 順に めぐっています。もし『下水処理場』が 無かったら、家で 使ったあとの よごれた水は どうなってしまうでしょう？",
        a:["きれいにされないまま 川や海に 流れてしまう","浄水場に もどって また きれいになる","消えて なくなる","ダムに たまる"], c:0,
