/* =====================================================================
   js/quizzes/english.js  ---  content.js分割：問題データ（英語（english）のみ）
   ---------------------------------------------------------------------
   読み込み順番： index.html で js/stages.js のあと、 js/patch.js より先に読み込むこと。
   window.CONTENT_QUIZZES_ENGLISH として公開し、js/patch.js が他教科ぶんとまとめて合流させる。
   ===================================================================== */
(function () {
  ...
  const QUIZZES = {
    "英語/あいさつ/english401": [
      ...
      { q:"友だちが「How are you?」と 聞いてきました。あなたは 今日 朝ごはんを 食べておらず、お腹が ぺこぺこです。この気持ちを 正しく 伝える 返事は どれでしょう？",
        a:["I'm hungry.","I'm happy.","I'm tired.","Thank you."], c:0,
  ...
  window.CONTENT_QUIZZES_ENGLISH = QUIZZES;
})();
