  ...
  const QUIZZES = {
    ...
    "算数/大きな数/ookazu01": [
      ...
      { q:"つぎの 2つの じょうけんに あう 数は どれでしょう？\n・8けたの数である\n・一億（100000000）を 10で わった数と 同じ",
        a:["10000000","1000000","1000000000","100000000"], c:0,
    ...
    "算数/面積/menseki_1": [
      ...
      { q:"つぎの 2つの じょうけんに あう 長方形は どれでしょう？\n・面積が 24\n・たての長さが よこの長さより 5 大きい",
        a:["たて8・よこ3","たて6・よこ4","たて12・よこ2","たて24・よこ1"], c:0,
      ...
      { q:"同じ 16この タイルで、よこを 4に すると、たては いくつ？ 数字で。",
        type:"text_input", correct_answers:["4","4こ"],
        hint:"4 × □ ＝ 16。",
    ...
    "算数/面積/menseki_2": [
      ...
      { q:"面積が 40の 長方形で、たてが 5の とき、よこは？ 数字で。",
        type:"text_input", correct_answers:["8","8こ"],
        hint:"40 ÷ 5。",
    ...
    "算数/図形/suichoku_heikou01": [
      ...
      { q:"ノートの けい線（横線）どうしは たがいに 平行です。この けい線に 垂直な たて線を 1本 引き、さらに べつの たて線も 同じ けい線に 垂直に 引きました。この 2本の たて線どうしは、どんな 関係に なるでしょう？",
        a:["平行（へいこう）","垂直（すいちょく）","対角","交わって しまう"], c:0,
    ...
    "算数/図形/shikakukei_bunrui01": [
      ...
      { q:"ある四角形は「4つの角が ぜんぶ 直角」で、「4つの辺の長さも ぜんぶ 等しい」という 2つの じょうけんを 満たしています。この四角形の 名前として いちばん 正確なのは どれでしょう？",
        a:["正方形（長方形の仲間でも ひし形の仲間でもある）","長方形だけ","ひし形だけ","台形"], c:0,
    ...
    "算数/図形/sankaku_bunrui01": [
      ...
      { q:"ある三角形は、2つの角が それぞれ 60度で、のこり1つの角も 60度です。この三角形に あてはまる 名前として いちばん 正確なのは どれでしょう？",
        a:["正三角形（二等辺三角形の仲間でもある）","二等辺三角形だけ","直角三角形","不等辺三角形"], c:0,
    ...
    "算数/図形/nakama_sagashi01": [
      ...
      { q:"二等辺三角形と 正方形に 共通する 特徴は どれでしょう？",
        a:["長さの等しい辺が ある","かどが ぜんぶ 直角","辺が ぜんぶ 平行","角の数が 同じ"], c:0,
    ...
    "算数/グラフ/oresen01": [
      ...
      { q:"あるグラフの線は、9時〜11時は 急な右上がり、11時〜13時は 水平、13時〜15時は 右下がりでした。気温が いちばん 変化しなかった 時間帯は どれでしょう？",
        a:["11時〜13時","9時〜11時","13時〜15時","ぜんぶ同じ"], c:0,
    ...
    "算数/わり算/warizan301": [
      ...
      { q:"つぎの じょうけんに あう「わり算」は どれでしょう？\n・わる数は 6\n・あまりは 正しく わる数より 小さい\n・商と あまりを たすと 9に なる",
        a:["39÷6＝6あまり3","33÷6＝5あまり3","45÷6＝7あまり3","27÷6＝4あまり3"], c:0,
